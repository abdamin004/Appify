    ...
    >
      <form onSubmit={onCreate} className="space-y-6">
        ...
        <div className="form-control">
          ...
          <textarea
            className="textarea w-full bg-white border border-slate-300 text-slate-900 placeholder-slate-400 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none transition-all h-32"
            value={form.agenda}
